...
Eunice is a system of utilities based on the premise that unidirectional dependencies can be beneficial to structure and modularity in software. This isn't constrained to direct dependencies only, but includes indirect dependencies as well.
