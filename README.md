...
- stack items
	- [at the root](Processors/stackItems/atRoot.js)
	- [using the file system (devsnicket.eunice.stack.yaml)](Processors/stackItems/usingFileSystem) (not available in test harness)
