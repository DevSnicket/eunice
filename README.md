...
Eunice is a system of utilities based on the premise that unidirectional dependencies can be beneficial to structure and modularity in software. It doesn't constrain this to direct dependencies, but includes indirect dependencies as well.
