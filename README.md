...
- create or add to stacks
	...
	- [to items with an identifier](Processors/createOrAddToStacks/toItemsWithIdentifier) (not available in test harnesses)
	- [using the file system (.devsnicket-eunice-stack.yaml)](Processors/createOrAddToStacks/usingFileSystem) (not available in test harnesses)
